...
<nav class="navbar navbar-expand-lg navbar-success py-2 sticky-top bg-white shadow">
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        ...
        <li class="nav-item">
            <a class="nav-link font-md font-regular" href="/">HOME</a>
        </li> 
        <li class="nav-item">
            <a class="nav-link font-md font-regular" href="/flight">FLIGHTS</a>
        </li>
        <li class="nav-item">
    ...
    @auth
      <div class="dropdown">
        ...
        <ul class="dropdown-menu my-3" aria-labelledby="dropdownMenuLink" style="margin-left: 14px;">
          <li>
            <a class="dropdown-item {{ $urlPath === '/my-profile' ? 'active-dropdown' : (($urlPath === '/my-profile-setting' ? 'active-dropdown' : '')) }}" href="/my-profile">
          ...
          <li>
            <a class="dropdown-item {{ $urlPath !== '/my-profile' ? 'active-dropdown' : (($urlPath !== '/my-profile-setting' ? 'active-dropdown' : '')) }}" href="/my-ticket">
